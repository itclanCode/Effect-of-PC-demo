...
mit.main = function() {
  ...
  */
  ...
  tweet.href='http://twitter.com/share?url=https://codecanyon.net/user/compogamezone/portfolio/&text=I am playing Fly modi fly, a cute HTML5 game on khele.in!&count=horiztonal&via=_rishabhp&related=solitarydesigns';

  var facebook = document.getElementById("fb");
  facebook.href='http://facebook.com/sharer.php?s=100&p[url]=https://codecanyon.net/user/compogamezone/portfolio/&p[title]=I am playing HTML5 game';
  ...
  */
  mit.gameOver = function() {
    ...
    mit.game_over = 1;
    mit.start_btn_clicked = 0;
	https://codecanyon.net/user/compogamezone/portfolio/
    ...
    // Share
    var tweet = document.getElementById("tweet");
    tweet.href='http://twitter.com/share?url=https://codecanyon.net/user/compogamezone/portfolio/&text=I just scored ' +Math.floor(mit.score)+ ' points in Pappu Pakia!&count=horiztonal&via=_rishabhp&related=solitarydesigns';
  
    var facebook = document.getElementById("fb");
    facebook.href='http://facebook.com/sharer.php?s=100&p[url]=https://codecanyon.net/user/compogamezone/portfolio/&p[title]=I just scored ' +Math.floor(mit.score)+ ' points in the Pappu Pakia!';
