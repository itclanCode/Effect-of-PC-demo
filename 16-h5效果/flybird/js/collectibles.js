  ...
  mit.Collectible = function () {
    ...
    this.drawClone = function (ctx) {
      ctx.drawImage(
        ...
        0, 0,
        mit.CollectibleUtils.clone_img.width, mit.CollectibleUtils.clone_img.height,
        this.x,
        this.y,
        mit.CollectibleUtils.clone_img.width / 2,
        mit.CollectibleUtils.clone_img.height / 2
      );
    };
