(function () {
  ...
  mit.Backgrounds = {
    ...
    init: function (ctx) {
      ...
      this.cloud_img.width = mit.W / 2;
      this.cloud_img.height = mit.H / 2;
    ...
    drawBackTrees: function (ctx) {
      ...
      try {
        ctx.drawImage(
          ...
          backtree_bg_vx_abs * 2,
          0,
          (mit.W + this.backtree_bg_vx) * 2,
          mit.H * 2,
    ...
    drawFrontTrees: function (ctx) {
      ...
      try {
        ctx.drawImage(
          ...
          fronttree_bg_vx_abs * 2,
          0,
          (mit.W + this.fronttree_bg_vx) * 2,
          mit.H * 2,
    ...
    drawCombinedBG: function (ctx) {
      ...
      try {
        ctx.drawImage(
          ...
          combined_bg_vx_abs * 2,
          0,
          (mit.W + this.combined_bg_vx) * 2,
          mit.H * 2,
