(function () {
  ...
  mit.Pakia = function () {
    ...
    this.draw = function (ctx) {
      ctx.drawImage(mit.PakiaUtils.pakia_img[this.type], this.x, this.y, mit.PakiaUtils.pakia_img[this.type].width / 2, mit.PakiaUtils.pakia_img[this.type].height / 2);
    };
  ...
  mit.PakiaUtils = {
    ...
    createPakias: function () {
      ...
      for (var i = 0; i < 3; i++) {
        ...
        pakia.w = this.pakia_img.sad.width / 2;
        pakia.h = this.pakia_img.sad.height / 2;
