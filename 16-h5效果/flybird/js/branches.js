    ...
    */
    ...
    create: function () {
      ...
      if (branches.length < count) {
        ...
        for (var i = 0; i < count - branches.length; i++) {
          ...
          branch.w = this.branch_img.width / 2;
          branch.h = this.branch_img.height / 2;
          ...
          branch.escape_w = this.branch_img.width / 2;
          branch.escape_h = 150;
    ...
    draw: function (ctx) {
      ...
      branches.forEach(function (branch, index) {
        ...
        // ctx.drawImage(branch_img, 0, 0, branch_img.w, branch_img.h, branch.x, branch.y, branch_img.w/2, branch_img.h/2);
        ctx.drawImage(branch_img, branch.x, branch.y, branch_img.width / 2, branch_img.height / 2);
    ...
    checkCollision: function () {
      ...
      if (utils.intersect(pappu_bounds, branch_bounds)) {
        ...
        if (!utils.intersect(pappu_bounds, escape_bounds)) {
          console.log(111, utils.intersect(pappu_bounds, escape_bounds))
          mit.gameOver();
        }
